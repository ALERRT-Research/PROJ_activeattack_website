---
#title: "The Anatomy of Active Attacks in the USA, 2000-2025"
format: 
  dashboard: 
    orientation: rows
    scrolling: true
...
{{< downloadthis data/aa_fact_sheet_2025.pdf dname="active_attack_factsheet_v2025" >}}
:::

::: {.card .flow title="2000 - 2025"}
There have been 634 active attacks identified.
...
Multiple Weapons used in 30.28% of events.
...
-   No Relationship: 415 (65.46%)

-   Employee/Former Employee: 99 (15.62%)

-   Student/Former Student: 72 (11.36%)
...
Prior to LE Arrival (374 \[58.99%\])

-   Shot by Civilian: 29 (4.57%)

-   Subdued by Civilian: 60 (9.46%)

-   Suicide before Police Arrival: 87 (13.72%)

-   Flee the Scene: 198 (31.23%)

After LE Arrival (260 \[41.01%\])

-   Shot by Police: 138 (21.77%)

-   Subdued by Police: 57 (8.99%)

-   Suicide after Police Arrival: 49 (7.73%)

-   Surrendered: 16 (2.52%)

# **Victims**

Total: 4,287 (Median \# of Victims: 4)

Wounded: 2,810 (Median \# of Wounded: 2)

Killed: 1,477 (Median \# of Victims Killed: 1)
:::
...
2.  The dataset also includes several variables with the *\_incl*
    ...
    the variable coding schemes. ALERRT applies more stringent
...
{{< downloadthis data/aa_data_wide_nogeo_2025.csv dname="active_attack_data_v2025" >}}
Data (*.csv*)

{{< downloadthis data/aa_data_wide_codebook_2025.docx dname="active_attack_data_v2025_codebook" >}}
Codebook (*.docx*)
:::
